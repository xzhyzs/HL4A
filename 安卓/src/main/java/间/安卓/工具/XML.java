...
public class XML {
    ...
    public void 保存(String $地址,Object $对象) {
        字符.保存($地址,转换($对象));
    }
    ...
    private static final void writeXml(Object val,OutputStream out)
    throws XmlPullParserException, java.io.IOException {
        XmlSerializer serializer = (XmlSerializer)反射.实例化(反射.取类("com.android.internal.util.FastXmlSerializer"));
        serializer.setOutput(out, "utf-8");
        serializer.startDocument(null, true);
        serializer.setFeature("http://xmlpull.org/v1/doc/features.html#indent-output", true);
        writeValueXml(val, null, serializer);
     ...
     * @see #readListXml
     */
    private static final void writeListXml(List val,OutputStream out)
    throws XmlPullParserException, java.io.IOException {
     ...
     * @see #readMapXml
     */
    private static final void writeMapXml(Map val,String name,XmlSerializer out)
    throws XmlPullParserException, java.io.IOException {
     ...
     * @hide
     */
    private static final void writeMapXml(Map val,XmlSerializer out,
                                          WriteMapCallback callback) throws XmlPullParserException, java.io.IOException {
        if (val == null) {
            return;
        }
     ...
     * @see #readListXml
     */
    private static final void writeListXml(List val,String name,XmlSerializer out)
    throws XmlPullParserException, java.io.IOException {
        if (val == null) {
            out.startTag(null, "null");
            out.endTag(null, "null");
    ...
    private static final void writeSetXml(Set val,String name,XmlSerializer out)
    throws XmlPullParserException, java.io.IOException {
        if (val == null) {
            out.startTag(null, "null");
            out.endTag(null, "null");
     ...
     * @see #writeValueXml
     */
    private static final void writeByteArrayXml(byte[] val,String name,
                                                XmlSerializer out)
    throws XmlPullParserException, java.io.IOException {
     ...
     */
    private static final void writeIntArrayXml(int[] val,String name,
                                               XmlSerializer out)
    throws XmlPullParserException, java.io.IOException {
     ...
     * @see #readThisIntArrayXml
     */
    private static final void writeLongArrayXml(long[] val,String name,XmlSerializer out)
    throws XmlPullParserException, java.io.IOException {
     ...
     * @see #readThisIntArrayXml
     */
    private static final void writeDoubleArrayXml(double[] val,String name,XmlSerializer out)
    throws XmlPullParserException, java.io.IOException {
     ...
     * @see #readThisIntArrayXml
     */
    private static final void writeStringArrayXml(String[] val,String name,XmlSerializer out)
    throws XmlPullParserException, java.io.IOException {
     ...
     * @see #readThisIntArrayXml
     */
    private static final void writeBooleanArrayXml(boolean[] val,String name,XmlSerializer out)
    throws XmlPullParserException, java.io.IOException {
     ...
     * @see #writeListXml
     */
    private static final ArrayList readListXml(InputStream in)
    throws XmlPullParserException, java.io.IOException {
        XmlPullParser   parser = Xml.newPullParser();
        parser.setInput(in, null);
     ...
     * @see #writeSetXml
     */
    private static final HashSet readSetXml(InputStream in)
    throws XmlPullParserException, java.io.IOException {
        XmlPullParser parser = Xml.newPullParser();
        parser.setInput(in, null);
     ...
     * @see #readMapXml
     */
    private static final HashMap<String, ?> readThisMapXml(XmlPullParser parser,String endTag,
     ...
     * @see #readListXml
     */
    private static final int[] readThisIntArrayXml(XmlPullParser parser,
     ...
     * @see #readListXml
     */
    private static final long[] readThisLongArrayXml(XmlPullParser parser,
                                                     String endTag,String[] name)
    throws XmlPullParserException, java.io.IOException {
     ...
     * @see #readListXml
     */
    private static final double[] readThisDoubleArrayXml(XmlPullParser parser,String endTag,
                                                         String[] name) throws XmlPullParserException, java.io.IOException {
     ...
     * @see #readListXml
     */
    private static final boolean[] readThisBooleanArrayXml(XmlPullParser parser,String endTag,
                                                           String[] name) throws XmlPullParserException, java.io.IOException {
    ...
    private static boolean nextElementWithin(XmlPullParser parser,int outerDepth)
    ...
    private static int readIntAttribute(XmlPullParser in,String name,int defaultValue) {
    ...
    private static long readLongAttribute(XmlPullParser in,String name,long defaultValue) {
        final String value = in.getAttributeValue(null, name);
        try {
    ...
    private static float readFloatAttribute(XmlPullParser in,String name) throws IOException {
        final String value = in.getAttributeValue(null, name);
        try {
    ...
    private static void writeFloatAttribute(XmlSerializer out,String name,float value)
    throws IOException {
        out.attribute(null, name, Float.toString(value));
    }

    private static boolean readBooleanAttribute(XmlPullParser in,String name) {
        final String value = in.getAttributeValue(null, name);
    ...
    private static void writeBooleanAttribute(XmlSerializer out,String name,boolean value)
    throws IOException {
        out.attribute(null, name, Boolean.toString(value));
    }

    private static Uri readUriAttribute(XmlPullParser in,String name) {
        final String value = in.getAttributeValue(null, name);
        return (value != null) ? Uri.parse(value) : null;
    }

    private static void writeUriAttribute(XmlSerializer out,String name,Uri value)
    throws IOException {
        if (value != null) {
    ...
    private static String readStringAttribute(XmlPullParser in,String name) {
        return in.getAttributeValue(null, name);
    }

    private static void writeStringAttribute(XmlSerializer out,String name,String value)
    throws IOException {
        if (value != null) {
    ...
    private static byte[] readByteArrayAttribute(XmlPullParser in,String name) {
        final String value = in.getAttributeValue(null, name);
        if (value != null) {
    ...
    private static void writeByteArrayAttribute(XmlSerializer out,String name,byte[] value)
    throws IOException {
        if (value != null) {
    ...
    private static Bitmap readBitmapAttribute(XmlPullParser in,String name) {
    ...
    @Deprecated
    private static void writeBitmapAttribute(XmlSerializer out,String name,Bitmap value)
    throws IOException {
        if (value != null) {
    ...
    /** @hide */
    private interface WriteMapCallback {
        /**
    ...
    /** @hide */
    private interface ReadMapCallback {
        /**
