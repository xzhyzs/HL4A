...
public class 列表<类型> extends ArrayList<类型> {

    public 列表() {
        super();
    }
    
    public 列表(Collection<类型> $列表) {
        this();
        添加所有($列表);
    }
    ...
    public 列表<类型> 添加(int $键值, 类型 $对象) {
        add($键值, $对象);
        return this;
    }

    public 列表<类型> 添加(类型 $对象) {
        add($对象);
        return this;
    }

    public 列表<类型> 添加所有(类型[] $对象) {
        for (类型 $单个 : $对象) {
            add($单个);
        }
        return this;
    ...
    public 列表<类型> 添加所有(int $键值, Collection<类型> $集合) {
        addAll($键值, $集合);
        return this;
    }

    public 列表<类型> 添加所有(Collection<类型> $集合) {
        addAll($集合);
        return this;
    }
